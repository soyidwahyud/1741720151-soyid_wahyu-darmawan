...
class BukuPerawat extends Component {
  state = {
    ListBukuPerawat:[]
  }
  ambilDataDariServerAPI = () =>{
    fetch('http://127.0.0.1:5000/buku_perawat')
      .then(response => response.json())
      .then(jsonHasilAmbilDariAPI => {
        this.setState({
          ListBukuPerawat: jsonHasilAmbilDariAPI
        })
      })
  }
  ...
  render() {
    return (
      <div className="animated fadeIn">
        ...
        <Row>
          {
            this.state.ListBukuPerawat.map(buku => {
